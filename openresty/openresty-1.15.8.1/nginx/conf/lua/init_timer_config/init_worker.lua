...
-- 定时器拉起location脚本路径
local srcipt_path                     = 
'/home/nginx/openresty/openresty-1.15.8.1/nginx/script/init_timer'


----------------------------------- healthcheck 定时器配置 --------------------------------------------- 
-- nginx upstream conf 路径
local healthcheck_upstream_filepath   =
'/home/nginx/openresty/openresty-1.15.8.1/nginx/conf/conf.d/lepai_balancer.conf'
...
'/home/nginx/openresty/openresty-1.15.8.1/nginx/script/upstream/init_upstream_conf'
...
local sockproc_path                   =
'/home/nginx/openresty/openresty-1.15.8.1/nginx/script/socket'
local sockproc_file                   =
'sockproc'
